...
/// Nash
/// </summary>
public class MoMaBakedEditor : EditorWindow
{
    [MenuItem("Tools/BakeMotion/Generic")]
    static void MakeWindow()
    {
        window = GetWindow(typeof(MoMaBakedEditor)) as MoMaBakedEditor;
        window.oColor = GUI.contentColor;
    }

    private static MoMaBakedEditor window;
